...
Route::post('/saving-shipping-details','CheckoutController@saving_shipping_details');
...
Route::get('/payement','CheckoutController@payement');
...
Route::get('/add-manufcature','ManufactureController@index');
