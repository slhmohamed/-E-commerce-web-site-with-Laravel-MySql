...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $all_publshed_product=DB::table('tbl_products')
    	...
    	->get();
    	 ...
    	 $manage_publshed_product=view('pages.home_content')
    	    ->with('all_publshed_product',$all_publshed_product);
    	return view('layout')
    		->with('pages.home_content',$manage_publshed_product);
//
