						...
						<form class="form-horizontal" action="{{ url('/update-manufacture',$manufacture_info->manufacture_id)}}" method="post">
						  ...
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Manufacture descreption</label>
							  <div class="controls">
								<textarea class="cleditor" name="manufacture_descreption" rows="3" >
									{{$manufacture_info->manufacture_descreption}}
								</textarea>
							  </div>
							</div>
