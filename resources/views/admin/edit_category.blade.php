						...
						<form class="form-horizontal" action="{{ url('/update-category',$category_info->category_id)}}" method="post">
						  ...
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Category_descreption</label>
							  <div class="controls">
								<textarea class="cleditor" name="category_descreption" rows="3" >
									{{$category_info->category_descreption}}
								</textarea>
							  </div>
							</div>
