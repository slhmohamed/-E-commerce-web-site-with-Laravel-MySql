			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/add-manufcature')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
						<li>
						...
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delivry Man</span></a></li>
